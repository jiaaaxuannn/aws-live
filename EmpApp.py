...
def FetchData():
    ...
    try:
        ...
        try:
            ...
            image_urll = 'https://chongjiaxuan-employee.s3.amazonaws.com/emp-id-1_image_file'
    ...
    return render_template("GetEmpOutput.html", id=output["emp_id"], fname=output["first_name"], lname=output["last_name"], interest=output["primary_skills"], location=output["location"], image_url=image_urll)
